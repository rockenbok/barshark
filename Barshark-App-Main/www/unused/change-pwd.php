...
if(isset($_POST['submittedChange']))
{
...
<input type='hidden' name='submittedChange' id='submittedChange' value='1'/>
...
<br/><br/><br/>
<div class='container'>
    <input type='submit' id='SubmitChange' name='SubmitChange' value='Change Password' />
</div>
